...
* specified.
*
* @remark There is no copy constructor. Use copyFade() to copy Fade_2D
* objects along with their Zone2 objects.
*/
 ...
 * @param [in] bProtectEdges specifies if existing edges shall be
 * locked by turning them into constraint segments
